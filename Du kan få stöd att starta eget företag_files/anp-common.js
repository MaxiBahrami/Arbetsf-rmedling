...
function checkForProcess() {
    if (rqstSts == 1) {
        prcBrSts = 1;
        if ("undefined" == typeof (__showAjaxProcessingLoader) || ("undefined" != typeof (__showAjaxProcessingLoader) && __showAjaxProcessingLoader)) InvokeToggleModalWindow('divLoader', 0, true);
    }
}
...
function __EndRequest(sender, args) {
    ...
    if (prcBrSts == 1) {
        prcBrSts = 0;
        if ("undefined" == typeof (__showAjaxProcessingLoader) || ("undefined" != typeof (__showAjaxProcessingLoader) && __showAjaxProcessingLoader)) InvokeToggleModalWindow('divLoader', 0, false);
    }
    ...
    if (null != error) {
        ...
        if ("undefined" != typeof (__endRequestHandlerArray)) FireEventHandlers(__endRequestHandlerArray, sender, args); InvokeSetFocus();
    }
...
function InvokeToggleModalWindow(windowContainer, type, show) {
    if (typeof (ToggleModalWindow) === "function") {
        ToggleModalWindow(windowContainer, type, show);
    } else if (window.parent && window.parent.window && typeof (window.parent.window.ToggleModalWindow) === "function") {
        window.parent.window.ToggleModalWindow(windowContainer, type, show);
    }
}
...
function InvokeSetFocus() {
    if (typeof (SetFocus) === "function") {
        SetFocus();
    } else if (window.parent && window.parent.window && typeof (window.parent.window.setFocus) === "function") {
        window.parent.window.setFocus();
    }
}
